...
router.get('/bills/:id', function(req, res){
  ...
  request("https://congress.api.sunlightfoundation.com/legislators?bioguide_id="+billID+"&all_legislators=true&apikey=31c861fcdf7a44918b337709913554ae", function(err, response, body1){
      var billIdResponse = JSON.parse(body1);
